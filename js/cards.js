const CARDS_CONFIG = {
    ...
    fallbackCards: [
        ...
        { id: 4, name: "El Catrin", image: "./img/cartas/4.jpg" },
        ...
        { id: 8, name: "El Barco", image: "./img/cartas/8.jpg" },
        { id: 9, name: "El Barril", image: "./img/cartas/9.jpg" },
        { id: 10, name: "El Arbol", image: "./img/cartas/10.jpg" },
        { id: 11, name: "El Futbolista", image: "./img/cartas/11.jpg" },
        ...
        { id: 15, name: "Los Viejitos", image: "./img/cartas/15.jpg" },
        { id: 16, name: "La Bandera", image: "./img/cartas/16.jpg" },
        { id: 17, name: "El Bandolon", image: "./img/cartas/17.jpg" },
        { id: 18, name: "La Guitarra", image: "./img/cartas/18.jpg" },
        { id: 19, name: "La Garza", image: "./img/cartas/19.jpg" },
        { id: 20, name: "El Pajaro", image: "./img/cartas/20.jpg" },
        ...
        { id: 27, name: "El Corazon", image: "./img/cartas/27.jpg" },
        { id: 28, name: "La Calandria", image: "./img/cartas/28.jpg" },
        { id: 29, name: "El Tambor", image: "./img/cartas/29.jpg" },
        { id: 30, name: "La Tehuana", image: "./img/cartas/30.jpg" },
        { id: 31, name: "Las Jaras", image: "./img/cartas/31.jpg" },
        { id: 32, name: "El Musico", image: "./img/cartas/32.jpg" },
        ...
        { id: 40, name: "El Alacran", image: "./img/cartas/40.jpg" },
        { id: 41, name: "La Rosa", image: "./img/cartas/41.jpg" },
        { id: 42, name: "El Trompo", image: "./img/cartas/42.jpg" },
        ...
        { id: 50, name: "El Balero", image: "./img/cartas/50.jpg" },
